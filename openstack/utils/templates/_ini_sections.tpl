...
transport_url = rabbit://{{ .Values.audit.central_service.user | required "Please set audit.central_service.user" }}:{{ .Values.audit.central_service.password | required "Please set audit.central_service.password" | urlquery }}@{{ .Values.audit.central_service.name | required "Please set audit.central_service.name" }}:{{.Values.audit.central_service.port | default 5672 }}/
